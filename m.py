...
bot = telebot.TeleBot('7555764604:AAHPyVq0g-pGd_WLFuhtoH1GP1PhaBWEBXU')
# DEVELOPER --> @KaliaYtOwner
# Admin user IDs
admin_id = ["1885926472","2097574959"]
...
f"🌪️ **𝗧𝗮𝗿𝗴𝗲𝘁 𝗸𝗼 𝗰𝗵𝗵𝗼𝗱𝗻𝗮 𝗺𝗮𝘁, 𝗝𝗮𝗹𝗱𝗶 𝗸𝗮𝗿 𝗻𝗶𝗽𝘁𝗮!** 🌪️"
    ...
    keyboard.add(
        telebot.types.InlineKeyboardButton("SUPPORT", url="https://t.me/+uzy3E6BZFNxmYjc9")
    )
...
"""
    keyboard = telebot.types.InlineKeyboardMarkup()
    keyboard.row(
        telebot.types.InlineKeyboardButton('Updates', url='https://t.me/+uzy3E6BZFNxmYjc9'),
        telebot.types.InlineKeyboardButton('Support', url='https://t.me/+uzy3E6BZFNxmYjc9')
    )
